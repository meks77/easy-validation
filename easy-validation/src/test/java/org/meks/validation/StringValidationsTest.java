...
public class StringValidationsTest {
    ...
    public void givenDateStringWitDay0WhenIsDateThenResultIsError() {
        ValidationResult result = StringValidations.isDate(DateTimeFormatter.ofPattern("yyyyMMdd")).test("19900100");
        assertErrorResult(result, ERROR_IS_DATE);
    }

    @Test
    public void givenDateStringWitMonth0WhenIsDateThenResultIsError() {
        ValidationResult result = StringValidations.isDate(DateTimeFormatter.ofPattern("yyyyMMdd")).test("19900001");
        assertErrorResult(result, ERROR_IS_DATE);
    }

    @Test
    public void givenDateStringWitDay32WhenIsDateThenResultIsError() {
        ValidationResult result = StringValidations.isDate(DateTimeFormatter.ofPattern("yyyyMMdd")).test("19900132");
        assertErrorResult(result, ERROR_IS_DATE);
    }

    @Test
    public void givenDateWithWrongFormatWhenIsDateThenResultIsError() {
        ValidationResult result = StringValidations.isDate(DateTimeFormatter.ofPattern("yyyyMMdd")).test("1990-10-32");
        assertErrorResult(result, ERROR_IS_DATE);
    }

    @Test
    public void givenAlphanumericStringWhenIsDateThenResultIsError() {
        ValidationResult result = StringValidations.isDate(DateTimeFormatter.ofPattern("yyyyMMdd")).test("invalid");
        assertErrorResult(result, ERROR_IS_DATE);
    }
